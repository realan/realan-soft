...
const ADD_SHOP = gql`
  mutation AddShopMutation($addData: shops_insert_input!) {
...
export default function AddShopDialog({ customerId }) {
  ...
  const [AddShopMutation, { loading, error }] = useMutation(ADD_SHOP);
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      // console.log(addData);
      AddShopMutation({ variables: { addData } });
      resetForm();
    }
  };
