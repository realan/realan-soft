...
import { ADD_ORDERS, DELETE_ORDERS, UPDATE_ORDERS } from "../GraphQL/Mutations";
...
const SetOrders = () => {
  const columns = [
    ...
    {
      Header: "Магазин заказчика",
      accessor: "customer_shop_id",
      type: "integer",
      show: true,
      required: false,
    },
    ...
    {
      Header: "От какой нашей фирмы доки",
      accessor: "our_firm_id",
      type: "integer",
      show: true,
      required: false,
    },
    ...
    {
      Header: "Получатель (фирма)",
      accessor: "consignee_firm_id",
      type: "integer",
      show: true,
      required: false,
    },
    {
      Header: "Получатель ЧЛ",
      accessor: "consignee_person_id",
      type: "integer",
      show: true,
      required: false,
    },
