...
import { GET_FIRMS } from "../GraphQL/Queries";
import { ADD_FIRMS, DELETE_FIRMS, UPDATE_FIRMS } from "../GraphQL/Mutations";
...
const SetFirms = () => {
  const columns = [
    ...
    {
      Header: "Реквизиты договора",
      accessor: "agreement_data",
      type: "text",
      show: true,
      required: false,
      initialState: "",
